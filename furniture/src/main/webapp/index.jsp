...
<script language="javascript" type="text/javascript">
    ...
    if(id=="hr1")
    {
        document.getElementById("mainFrame").src="${pageContext.request.contextPath }/people/peoplelabelManage.do?pageno=1";
    ...
    {
    document.getElementById("mainFrame").src="${pageContext.request.contextPath }/branch/newslabelManage.do?pageno=1";
    document.getElementById("dTitle").style.display="none";
    }
        else if(id=="hr21")
    {
    ...
    {
    document.getElementById("mainFrame").src="${pageContext.request.contextPath }/test/newslabelManage.do?pageno=1";
...
//    }
    ...
    {
    document.getElementById("mainFrame").src="${pageContext.request.contextPath }/product/newslabelManage.do?pageno=1";
    document.getElementById("dTitle").style.display="none";
    }
      else if(id=="hr44")
    {
...
<p class="logo">
<a href="index-x.html">
<img src="images/logo_03.gif" alt=""></a></p>
...
<ul>
<li><a onclick="srcchange('hr1');" style="cursor: hand">人事管理</a></li>
<li><a onclick="srcchange('hr2');" style="cursor: hand">行政管理</a></li>
</ul>
</div>
</div>
...
<ul>
<li><a onclick="srcchange('hr15')" style="cursor: hand">公告类别</a></li>
<li><a onclick="srcchange('hr17')" style="cursor: hand">公告管理</a></li>
<li><a onclick="srcchange('hr18')" style="cursor: hand">公告统计</a></li>
...
<ul>
<li><a onclick="srcchange('hr4');" style="cursor: hand">项目档案管理</a></li>
<li><a onclick="srcchange('hr5');" style="cursor: hand">项目心得</a></li>
<li><a onclick="srcchange('hr6');" style="cursor: hand">图片管理</a></li>
<li><a onclick="srcchange('hr7');" style="cursor: hand">常见问题</a></li>
<li><a onclick="srcchange('hr497');" style="cursor: hand">培训资料</a></li>
<li><a onclick="srcchange('hr498');" style="cursor: hand">其它资料</a></li>
<li><a onclick="srcchange('hr499');" style="cursor: hand">个人资料</a></li>
<li><a onclick="srcchange('hr500');" style="cursor: hand">知识审核</a></li>
</ul>
</div>
</div>
...
<ul>
<li><a onclick="srcchange('hr8');" style="cursor: hand">日程查看</a></li>
...
<li><a onclick="srcchange('hr11');" style="cursor: hand">任务延期申请</a></li>
<li><a onclick="srcchange('hr12');" style="cursor: hand">任务延期审批</a></li>
<li><a onclick="srcchange('hr13');" style="cursor: hand">任务转移</a></li>
<li><a onclick="srcchange('hr14');" style="cursor: hand">任务转移审批</a></li>
<li><a onclick="srcchange('hr34');" style="cursor: hand">任务成果提交</a></li>
</ul>
</div>
</div>
...
<ul>
<li><a onclick="srcchange('hr24');" style="cursor: hand">订单管理</a></li>
<li><a onclick="srcchange('hr25');" style="cursor: hand">客户管理</a></li>
</ul>
</div>
</div>
...
<ul>
<li><a onclick="srcchange('hr36');" style="cursor: hand">项目信息查看</a></li>
<li><a onclick="srcchange('hr38');" style="cursor: hand">项目任务分配</a></li>
<li><a onclick="srcchange('hr39');" style="cursor: hand">项目进度查询</a></li>
<li><a onclick="srcchange('hr40');" style="cursor: hand">项目进度验收</a></li>
<li><a onclick="srcchange('hr42');" style="cursor: hand">项目归档审核</a></li>
</ul>
</div>
</div>
...
<ul>
<li><a onclick="srcchange('hr20')" style="cursor: hand">部门管理</a></li>
<li><a onclick="srcchange('hr23')" style="cursor: hand">审批文档流程管理</a></li>
<li><a onclick="srcchange('hr21')" style="cursor: hand">角色管理</a></li>
<li><a onclick="srcchange('hr22')" style="cursor: hand">权限管理</a></li>
<li><a onclick="srcchange('hr19')" style="cursor: hand">系统参数设置</a></li>
<li><a onclick="srcchange('hr26')" style="cursor: hand">常规功能管理</a></li>
<li><a onclick="srcchange('hr27')" style="cursor: hand">自定义功能管理</a></li>
</ul>
</div>
</div>
...
<ul>
<li><a onclick="srcchange('hr43');" style="cursor: hand">产品系列管理</a></li>
<li><a onclick="srcchange('hr44')" style="cursor: hand">产品风格管理</a></li>
<li><a onclick="srcchange('hr45')" style="cursor: hand">产品规格管理</a></li>
<li><a onclick="srcchange('hr46')" style="cursor: hand">产品管理</a></li>
<li><a onclick="srcchange('hr47')" style="cursor: hand">产品查看</a></li>
<li><a onclick="srcchange('hr49')" style="cursor: hand">个人收藏夹查看</a></li>
<li><a onclick="srcchange('hr50')" style="cursor: hand">产品展示管理</a></li>
</ul>
...
<a href="${pageContext.request.contextPath }/people/peoplelabelManage.do?pageno=1" onclick="changeIcon('HR')" target="mainFrame" onmousedown="javascript:pr('xx1')"><span></span>
<p class="icon_01">
人事行政管理</p>
</a></li>
<li class="y_css" id="xx2">
<a href="notice/NoticeClass.html" onclick="changeIcon('Notice')" target="mainFrame" onmousedown="javascript:pr('xx2')" onmouseover="show(2)" onmouseout="hidden1(2)"><span></span>
<p class="icon_10">
系统公告</p>
</a></li>
<li class="y_css" id="xx3">
<a href="knowledge/KnowLedgeClass.html" target="mainFrame" onclick="changeIcon('KnowLedge')" onmousedown="javascript:pr('xx3')" onmouseover="show(3)" onmouseout="hidden1(3)">
<span></span>
<p class="icon_02">
知识管理</p>
</a></li>
<li class="y_css" id="xx4">
<a href="task/Schedule.html" onclick="changeIcon('Task')" target="mainFrame" onmousedown="javascript:pr('xx4')" onmouseover="show(4)" onmouseout="hidden1(4)"><span></span>
<p class="icon_04">
任务管理</p>
</a></li>
<li class="y_css" id="xx5">
<a href="${pageContext.request.contextPath }/test/newslabelManage.do?pageno=1" onclick="changeIcon('Order')" target="mainFrame" onmousedown="javascript:pr('xx5')" onmouseover="show(5)" onmouseout="hidden1(5)"><span></span>
<p class="icon_05">
销售管理</p>
</a></li>
<li class="y_css" id="xx6">
<a href="item/Item.html" onclick="changeIcon('Item')" target="mainFrame" onmousedown="javascript:pr('xx6')" onmouseover="show(6)" onmouseout="hidden1(6)"><span></span>
<p class="icon_07">
项目管理</p>
</a></li>
...
<a href="${pageContext.request.contextPath }/branch/newslabelManage.do?pageno=1" onclick="changeIcon('System')" target="mainFrame" onmousedown="javascript:pr('xx8')" onmouseover="show(8)" onmouseout="hidden1(8)"><span></span>
<p class="icon_12">
系统设置</p>
</a></li>
<li class="y_css" id="xx9">
<a href="${pageContext.request.contextPath }/product/newslabelManage.do?pageno=1" target="mainFrame" onclick="changeIcon('Product')" onmousedown="javascript:pr('xx9')" onmouseover="show(9)" onmouseout="hidden1(9)">
<span></span>
<p class="icon_03">
产品资料管理</p>
</a></li>
...
<img src="images/middil_05.gif" alt=""><a href="login.jsp"><img alt="" src="images/middil_06.gif"></a></div>
<iframe frameborder="0" style="margin-top: 15px; height: 631px;" width="1215" id="mainFrame" name="mainFrame" src="index1.html"></iframe>
  </td>
