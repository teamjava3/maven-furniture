...
<title>栏目修改</title>
<script>
function xiugai2(rid)
{
	var str = confirm("是否确定修改栏目名称？");
	if(str == true)
	{
		document.getElementById("form1").action="${pageContext.request.contextPath }/people/updatePeopleLabel.do";
...
<center>
  ...
  <form name="form1" id="form1" method="post" action="">
    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table01">
      <tr>
      	<input type="hidden" name="sid" value="${peopleLabel.rid }">
        <td class="td_02">员工姓名</td>
        <td class="td_02"><input name="name" value="${peopleLabel.rname }" type="text" class="input" style="width:99% "></td>
      </tr>
      <tr>
        <td class="td_02">性别</td>
        <td class="td_02"><input name="name" value="${peopleLabel.sex }" type="text" class="input" style="width:99% "></td>
      </tr>
       <tr>
        <td class="td_02">电话号码</td>
        <td class="td_02"><input name="name" value="${peopleLabel.number }" type="text" class="input" style="width:99% "></td>
      </tr>
       <tr>
        <td class="td_02">职位</td>
        <td class="td_02"><input name="name" value="${peopleLabel.position }" type="text" class="input" style="width:99% "></td>
      </tr>
    ...
    <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td class="td_page"><div align="center">
            ...
            <input name="Submit" type="submit" class="buttonface02" value="  修 改  " onClick="xiugai2(${peopleLabel.rid })">
            &nbsp;&nbsp;
