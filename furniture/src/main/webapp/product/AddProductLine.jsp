...
function tianjia()
{
	...
	if(str == true)
	{
		document.getElementById("form1").action="${pageContext.request.contextPath }/product/addNewsLabel.do";
		alert("添加成功");
	}
...
<center>
  ...
  <form name="form1" id="form1" method="post" action="">
    <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="table01">
      <tr>
        <td colspan="2" class="td_02" align="center">增加家具系列</td>
      </tr>
     
      <tr>
        <td width="14%" class="td_02">系列名称</td>
        <td width="86%" class="td_02"><input name="name" type="text" class="input" style="width:99% "></td>
      </tr>
     <tr>
        <td width="14%" class="td_02">系列备注</td>
        <td width="86%" class="td_02"><input name="information" type="text" class="input" style="width:99% "></td>
      </tr>
