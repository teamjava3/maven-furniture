...
function tianjia()
{
	...
	if(str == true)
	{
		document.getElementById("form1").action="${pageContext.request.contextPath }/branch/addNewsLabel.do";
		alert("添加成功");
	}
