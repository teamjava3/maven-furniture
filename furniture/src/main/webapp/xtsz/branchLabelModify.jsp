...
function xiugai2(id)
{
	...
	if(str == true)
	{
		document.getElementById("form1").action="${pageContext.request.contextPath }/branch/updateNewsLabel.do";
...
<center>
  ...
  <form name="form1" id="form1" method="post" action="">
    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table01">
      <tr>
      	<input type="hidden" name="sid" value="${branch.id }">
        <td class="td_02">部门名称</td>
        <td class="td_02"><input name="name" value="${branch.name }" type="text" class="input" style="width:99% "></td>
      </tr>
      <tr>
        <td class="td_02">部门简称</td>
        <td class="td_02"><input name="name" value="${branch.ab }" type="text" class="input" style="width:99% "></td>
      </tr>
       <tr>
        <td class="td_02">备注</td>
        <td class="td_02"><input name="name" value="${branch.position }" type="text" class="input" style="width:99% "></td>
      </tr>
    ...
    <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td class="td_page"><div align="center">
            ...
            <input name="Submit" type="submit" class="buttonface02" value="  修 改  " onClick="xiugai2(${branch.id })">
            &nbsp;&nbsp;
